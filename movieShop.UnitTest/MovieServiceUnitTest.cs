...
namespace movieShop.UnitTest
{
    ...
    public class MovieServiceUnitTest
    {
        ...
        */
        ...
        private Mock<IMovieRepository> _mockMovieRepository;[TestInitialize]
        ...
        {            // Arrange
                     ...
                     //  _sut = new MovieService(new MockMovieRepository());            // Act
            var movies = await _sut.GetTopRevenueMovies();            // check the actual output with expected data.
            // AAA
            // Arrange, Act and Assert            // Assert
